...
import Personality from 'src/personality/Personality';

export default angular.module('starter-app', ['ngMaterial', 'ngSanitize', GiftSearch.name, Personality.name]).config(($mdIconProvider, $mdThemingProvider) => {
